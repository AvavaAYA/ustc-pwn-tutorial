...
void readNote(char *buffer, int offset, int length) {
    write(1, buffer+offset, length);
}
void writeNote(char *buffer, int offset, int length) {
...
void menu() {
    ...
    puts("[0] have a look at my note");
    puts("[1] change my note");
    puts("======================================");
...
int main() {
    ...
    for (int i = 0; i < 16; i++) {
        ...
        cmdtb[choice](note_page, offs, leng);
    }
}
