                    ...
                    for (BasicBlock::iterator I_iter = curBB->begin(); I_iter != curBB->end(); ++I_iter) {
                        ...
                        if (CallInst *inst = dyn_cast<CallInst>(I)){
                            ...
                            if (Name == "qiaoKe") {
                                ...
                                unsigned int stu_id = dyn_cast<ConstantInt>(inst->getArgOperand(1))->getZExtValue();
                                ...
                                *(long long*)(studentList[stu_id] + 8) = helper_regs[1];
                                ...
                                unsigned int reg_id = dyn_cast<ConstantInt>(inst->getArgOperand(0))->getZExtValue();
                                long long data = dyn_cast<ConstantInt>(inst->getArgOperand(1))->getZExtValue();
                                if (reg_id >= 3){
                                    return false;
                                }
                                ...
                                unsigned int reg_id_dest = dyn_cast<ConstantInt>(inst->getArgOperand(0))->getZExtValue();
                                unsigned int reg_id_src  = dyn_cast<ConstantInt>(inst->getArgOperand(1))->getZExtValue();
                                if (reg_id_dest >= 3){
                                    return false;
                                }
                                if (reg_id_src  >= 3){
...
// Register for opt
static RegisterPass<bianYiYuanLiXiTiKe> X("bianYiYuanLiXiTiKe", "Do You Love Bianyiyuanli?");
